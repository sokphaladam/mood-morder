...
export function PrintV2(props: Props) {
  ...
  return (
    <>
      <button onClick={onPrintClicked} ref={props.refbtn} className="bg-indigo-800 p-1 text-white rounded-md max-h-[24px] text-[0.75rem] hidden">
        Print Recipt(Beta)
      </button>
      <div
        style={{
      ...
      >
        <div ref={ref}>
          <link type="text/css" rel="stylesheet" href={`${config_app.public.assets.print}`} />
